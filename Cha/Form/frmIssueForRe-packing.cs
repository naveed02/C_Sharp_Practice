...
namespace Cha
{
    public partial class frmIssueForRepacking : Form
    {
        int fcboDefaultValue = 0;
        public frmIssueForRepacking()
        {
            InitializeComponent();
        }

        private void frmIssueForRepacking_Load(object sender, EventArgs e)
        {
        ...
        private void frmIssueForRepacking_KeyDown(object sender, KeyEventArgs e)
        {
