...
namespace Cha
{
    public partial class frmIssueItemsBatchWiseDepartment : Form
    {
        int fcboDefaultValue = 0;
        public frmIssueItemsBatchWiseDepartment()
        {
            InitializeComponent();
        }

        private void frmIssueItemsBatchWiseDepartment_Load(object sender, EventArgs e)
        {
        ...
        private void frmIssueItemsBatchWiseDepartment_KeyDown(object sender, KeyEventArgs e)
        {
