...
namespace Cha
{
    public partial class frmIssueReturnItems : Form
    {
        int fcboDefaultValue = 0;
        public frmIssueReturnItems()
        {
            InitializeComponent();
        }

        private void frmIssueReturnItems_Load(object sender, EventArgs e)
        {
        ...
        private void frmIssueReturnItems_KeyDown(object sender, KeyEventArgs e)
        {
